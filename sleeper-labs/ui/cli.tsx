...
try {
  ...
  if(values.help) {
    ...
    if(values.record!=='bird'&&values.record!=='bird-curl'&&values.record!=='bird-alert'&&values.record!=='encrypted') throw Error('--record must be bird, bird-curl, bird-alert, or encrypted.');
    ...
    if(values['two-cases'])throw Error('Use --two-cases with a bird recording demo.');
