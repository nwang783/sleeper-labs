...
def call_record(line, messages, deployment, deadline, **extra):
    request = {"model": deployment, "messages": messages, "temperature": 0, "max_tokens": 1024, **extra}
...
def self_check():
    ...
    print("Verified input hashes, independent original bases, settings, budget, and expired-request handling.")
